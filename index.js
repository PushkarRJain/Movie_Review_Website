...
app.get("/", function(req, res){
  var mov1 = Number(results[0].rating)/Number(results[0].tot);
  if(results[0].tot==0){mov1 = 0};
  console.log(mov1);
  var mov2 = Number(results[1].rating)/Number(results[1].tot);
  if(results[1].tot==0){mov2 = 0};
  console.log(mov2);
  var mov3 = Number(results[2].rating)/Number(results[2].tot);
  if(results[2].tot==0){mov3 = 0};
  console.log(mov3);
  var mov4 = Number(results[3].rating)/Number(results[3].tot);
  if(results[3].tot==0){mov4 = 0};
  console.log(mov4);
  var mov5 = Number(results[4].rating)/Number(results[4].tot);
  if(results[4].tot==0){mov5 = 0};
  console.log(mov5);
  var mov6 = Number(results[5].rating)/Number(results[5].tot);
  if(results[5].tot==0){mov6 = 0};
  console.log(mov6);
  var mov7 = Number(results[6].rating)/Number(results[6].tot);
  if(results[6].tot==0){mov7 = 0};
  console.log(mov7);
  var mov8 = Number(results[7].rating)/Number(results[7].tot);
  if(results[7].tot==0){mov8 = 0};
  console.log(mov8);
  var mov9 = Number(results[8].rating)/Number(results[8].tot);
  if(results[8].tot==0){mov9 = 0};
  console.log(mov9);
  var mov10 = Number(results[9].rating)/Number(results[9].tot);
  if(results[9].tot==0){mov10 = 0};
  console.log(mov10);
  var mov11 = Number(results[10].rating)/Number(results[10].tot);
  if(results[10].tot==0){mov11 = 0};
  console.log(mov11);
  var mov12 = Number(results[11].rating)/Number(results[11].tot);
  if(results[11].tot==0){mov12 = 0};
  console.log(mov12);
  res.render('index',{mov1:mov1,mov2:mov2,mov3:mov3,mov4:mov4,mov5:mov5,mov6:mov6,mov7:mov7,mov8:mov8,mov9:mov9,mov10:mov10,mov11:mov11,mov12:mov12});
});
...
app.get('/:inp',function(req,res){
  ...
  Review.find({ name: param }, function(err, results) {
    if (err) {
      ...
      var avg = Number(tot_rat)/Number(tot_user);
      console.log("avg",avg);
